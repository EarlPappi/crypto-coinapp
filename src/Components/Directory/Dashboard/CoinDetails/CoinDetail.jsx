    ...
    <div>
      ...
      {loading ?
        <div className='flex flex-col gap-8 justify-center items-center py-8'>
          ...
          <h1 className='bg-black text-white px-4 py-2 '>Chill, Coin Details Loading</h1>
        ...
        <div>
          ...
          <div className='w-11/12 mx-auto p-6 rounded-xl bg-[#EEF1F3] mb-6' >
            ...
            <div>
              <div className='lg:flex my-4 gap-4 rounded-lg'>

                <div className='flex lg:w-1/3 flex-col gap-8 justify-center p-8 bg-slate-300 rounded-2xl'>
                ...
                <div className='my-2 lg:my-0 lg:w-2/3 bg-slate-300 p-4 rounded-2xl'>
                  <div className='lg:flex items-center gap-4 mb-2'>
